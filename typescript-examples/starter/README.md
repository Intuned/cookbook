...
<!-- IDE-IGNORE-START -->
<a href="https://app.intuned.io?repo=https://github.com/Intuned/cookbook/tree/main/typescript-examples/starter" target="_blank" rel="noreferrer"><img src="https://cdn1.intuned.io/button.svg" alt="Run on Intuned"></a>
<!-- IDE-IGNORE-END -->
...
starter/
├── api/
│   └── sample.ts                      # Minimal API scaffold to build from
├── intuned-resources/
│   └── jobs/
